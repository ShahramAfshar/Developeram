...
namespace Developeram.Web.Areas.Admin.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GroupId,Title,ShortText,FullText,CreateTime")] Group group, HttpPostedFileBase imgup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GroupId,Title,ShortText,FullText,CreateTime,ImageName")] Group group, HttpPostedFileBase imgup)
        {
            if (ModelState.IsValid)
            {
